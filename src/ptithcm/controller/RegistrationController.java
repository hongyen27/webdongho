...
import ptithcm.dao.impl.RegisterDao;
...
public class RegistrationController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		{
			request.setAttribute("Message", "Bạn đã tạo tài khoản thành công. Mời bạn đăng nhập <a href='/WEBDONGHO/view/client/login'>tại đây!</a>");
			RequestDispatcher rd = request.getRequestDispatcher("/view/client/register.jsp");
			rd.forward(request, response);
		} else {
			request.setAttribute("errMessage", "Tạo tài khoản thất bại. Hãy tạo lại !!!");
			RequestDispatcher rd = request.getRequestDispatcher("/view/client/register.jsp");
			rd.forward(request, response);
		}
	}
