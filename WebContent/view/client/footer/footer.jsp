            ...
            <div class="row">
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <a href="${pageContext.request.contextPath}/"><img src="${url}/images/logodh.jpg" alt="logo img" width="100px"></a> 
                  <ul class="aa-footer-nav">

                    <li><p style="color:#888; text-align: justify; width: 95%">Là nơi chuyên buôn bán tất cả các mặt hàng về đồng hồ. Chúng tôi luôn đặt tiêu chí về chất lượng và uy tín lên hàng đầu.</p></li>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>LIÊN HỆ</h3>
                    <address>
                      <p>234 Lê Đức Thọ - P.6 - Q.Gò Vấp - TP HCM</p>
                      <p><span class="fa fa-phone"></span>0344.96.4466</p>
                      <p><span class="fa fa-envelope"></span>lehongyen98@gmail.com</p>
                    </address>
